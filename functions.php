...
if ( ! function_exists( 'block_theme_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'block_theme-tailwind', get_template_directory_uri() . '/tailwind_theme/tailwind.css', [], '1.0.33', 'all');

    wp_deregister_style( 'block_theme-style' );
    wp_enqueue_style( 'block_theme-style', get_bloginfo('stylesheet_url'), [], '1.0.33', 'all');
...
$categories = array_merge( $categories, array( array(
        'slug' => 'my_blocks',
        'title' => __( 'My blocks', 'block_theme' )
    ) ) );
